...
from cli_modules.utils import create_temp_link

def main():
    parser = argparse.ArgumentParser(description='Create a temporary download link for a file.')
    parser.add_argument('command', choices=['start', 'stop', 'create-link','ngrok_token'], help='Command to execute')
    parser.add_argument('--file', type=str, help='Path to the file')
    parser.add_argument('--token', type=str, help='token og ngrok')
